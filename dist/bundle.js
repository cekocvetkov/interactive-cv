...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ctx = exports.canvas = exports.setColor = void 0;
const LINE_WIDTH = 2;
...
exports.canvas = canvasElement;
exports.ctx = contextElement;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.saveState = exports.clearAll = exports.undo = exports.drawing = exports.paint = exports.getMousePos = void 0;
const Canvas_1 = __webpack_require__(/*! ./Canvas */ "./src/Canvas.ts");
let lastX, lastY;
let canvasState = [];
let currentLine = [];
function getMousePos(e) {
    var rect = Canvas_1.canvas.getBoundingClientRect();
    return {
        x: ((e.clientX - rect.left) / (rect.right - rect.left)) * Canvas_1.canvas.width,
        y: ((e.clientY - rect.top) / (rect.bottom - rect.top)) * Canvas_1.canvas.height,
    };
}
exports.getMousePos = getMousePos;
function paint(x, y) {
    Canvas_1.ctx.beginPath();
    Canvas_1.ctx.moveTo(lastX, lastY);
    Canvas_1.ctx.lineTo(x, y);
    ...
    currentLine.push({
        x: lastX,
        y: lastY,
        color: Canvas_1.ctx.strokeStyle.toString(),
    });
}
exports.paint = paint;
...
function undo() {
    Canvas_1.ctx.clearRect(0, 0, Canvas_1.canvas.width, Canvas_1.canvas.height);
    ...
    for (let drawLine of canvasState) {
        ...
        console.log(pLast);
        Canvas_1.ctx.beginPath();
        Canvas_1.ctx.strokeStyle = pLast.color;
        for (let i = 1; i < drawLine.length - 1; i++) {
            let p = drawLine[i];
            Canvas_1.ctx.moveTo(pLast.x, pLast.y);
            Canvas_1.ctx.lineTo(p.x, p.y);
            pLast = p;
            lastX = pLast.x;
            lastY = pLast.y;
        }
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.forbidContextMenuRightClick = void 0;
const rxjs_1 = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/dist/cjs/index.js");
const Canvas_1 = __webpack_require__(/*! ./Canvas */ "./src/Canvas.ts");
const Drawing_1 = __webpack_require__(/*! ./Drawing */ "./src/Drawing.ts");
__webpack_require__(/*! ./styles.css */ "./src/styles.css");
const RIGHT_CLICK = 2;
document.addEventListener("DOMContentLoaded", () => {
    forbidContextMenuRightClick();
    const $mouseMove = (0, rxjs_1.fromEvent)(document, "mousemove");
    const $mouseDown = (0, rxjs_1.fromEvent)(document, "mousedown");
    const $mouseUp = (0, rxjs_1.fromEvent)(document, "mouseup");
    const $clearAll = (0, rxjs_1.fromEvent)(document.getElementById("clearAll"), "click");
    const $undo = (0, rxjs_1.fromEvent)(document.getElementById("undo"), "click");
    const $colorPaletteClick = (0, rxjs_1.fromEvent)(document.getElementById("color-picker"), "click");
    const $colorPaletteChange = (0, rxjs_1.fromEvent)(document.getElementById("color-picker"), "change");
    $clearAll.subscribe(() => (0, Drawing_1.clearAll)());
    $undo.subscribe(() => (0, Drawing_1.undo)());
    $colorPaletteClick.subscribe(() => { var _a; return (_a = document.getElementById("color-picker-input")) === null || _a === void 0 ? void 0 : _a.click(); });
    $colorPaletteChange.subscribe((event) => {
        console.log(event.target.value);
        (0, Canvas_1.setColor)(event.target.value);
    });
    const $paint = $mouseDown.pipe((0, rxjs_1.tap)((e) => console.log(e.button)), (0, rxjs_1.filter)((e) => e.button === RIGHT_CLICK), (0, rxjs_1.mergeMap)((down) => $mouseMove.pipe((0, rxjs_1.takeUntil)($mouseUp.pipe((0, rxjs_1.filter)((e) => e.button === RIGHT_CLICK))))));
    $mouseUp.subscribe(() => {
        console.log("save");
        (0, Drawing_1.saveState)();
    });
    $paint.subscribe((e) => (0, Drawing_1.drawing)(e));
});
function forbidContextMenuRightClick() {
    const $contextMenu = (0, rxjs_1.fromEvent)(document, "contextmenu");
    $contextMenu.subscribe((e) => {
        e.preventDefault();
        return false;
    });
}
exports.forbidContextMenuRightClick = forbidContextMenuRightClick;
